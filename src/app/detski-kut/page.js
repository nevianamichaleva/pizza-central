      ...
      <div className="container">
        ...
        <div className="row gy-4 mb-5">
          <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div className="content">
              <h3 style={{ color: 'var(--heading-color)', marginBottom: '20px', fontFamily: 'var(--heading-font)' }}>
                Какво предлага нашият детски кът?
              </h3>
              <ul style={{ listStyle: 'none', padding: 0 }}>
                <li style={{ marginBottom: '15px' }}>
                  <i className="bi bi-check-circle-fill" style={{ color: '#ce1212', marginRight: '10px' }}></i>
                  <span><strong>Безопасна игрова зона</strong> – специално проектирана за деца с меки подложки и закръглени ръбове</span>
                </li>
                <li style={{ marginBottom: '15px' }}>
                  <i className="bi bi-check-circle-fill" style={{ color: '#ce1212', marginRight: '10px' }}></i>
                  <span><strong>Разнообразни играчки</strong> – кубчета, пъзели, цветни моливи и много други занимания</span>
                </li>
                <li style={{ marginBottom: '15px' }}>
                  <i className="bi bi-check-circle-fill" style={{ color: '#ce1212', marginRight: '10px' }}></i>
                  <span><strong>Детски масички</strong> – удобни места, където децата могат да рисуват и играят</span>
                </li>
                <li style={{ marginBottom: '15px' }}>
                  <i className="bi bi-check-circle-fill" style={{ color: '#ce1212', marginRight: '10px' }}></i>
                  <span><strong>Визуален контрол</strong> – детският кът е разположен така, че родителите винаги да виждат децата си</span>
                </li>
                <li style={{ marginBottom: '15px' }}>
                  <i className="bi bi-check-circle-fill" style={{ color: '#ce1212', marginRight: '10px' }}></i>
                  <span><strong>Чистота и хигиена</strong> – редовно почистване и дезинфекция на всички играчки</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="row gy-4 mb-5">
          <div className="col-lg-12" data-aos="fade-up" data-aos-delay="300">
            <div className="content">
              <h3 style={{ color: 'var(--heading-color)', marginBottom: '20px', fontFamily: 'var(--heading-font)', textAlign: 'center' }}>
              ...
              <div className="row gy-4">
                <div className="col-md-4" data-aos="fade-up" data-aos-delay="350">
                  <div className="text-center" style={{ padding: '20px' }}>
                    ...
                    <h4 style={{ fontFamily: 'var(--heading-font)', marginBottom: '10px' }}>Спокойствие за родителите</h4>
                    <p>Знаете, че децата ви са в безопасна среда и се забавляват, докато вие се наслаждавате на спокойна вечеря.</p>
                  </div>
                </div>
                <div className="col-md-4" data-aos="fade-up" data-aos-delay="400">
                  <div className="text-center" style={{ padding: '20px' }}>
                    <i className="bi bi-emoji-smile-fill" style={{ fontSize: '48px', color: '#ce1212', marginBottom: '15px', display: 'block' }}></i>
                    <h4 style={{ fontFamily: 'var(--heading-font)', marginBottom: '10px' }}>Радост за децата</h4>
                    <p>Децата ви ще се забавляват с различни занимания, което прави посещението приятно и за тях.</p>
                  </div>
                </div>
                <div className="col-md-4" data-aos="fade-up" data-aos-delay="450">
                  <div className="text-center" style={{ padding: '20px' }}>
                    ...
                    <h4 style={{ fontFamily: 'var(--heading-font)', marginBottom: '10px' }}>Семейни моменти</h4>
                    <p>Перфектно място за семейни срещи, където всички членове на семейството могат да се насладят.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="row gy-4">
          <div className="col-lg-12" data-aos="fade-up" data-aos-delay="500">
            <h3 style={{ color: 'var(--heading-color)', marginBottom: '30px', fontFamily: 'var(--heading-font)', textAlign: 'center' }}>
          ...
          <div className="col-lg-12" data-aos="fade-up" data-aos-delay="700">
            <div className="content text-center" style={{ padding: '40px', backgroundColor: 'var(--surface-color)', borderRadius: '8px' }}>
              ...
              <p style={{ fontSize: '22px', marginBottom: '30px' }}>
                Очакваме ви и вашите деца в ресторант-пицария <strong>„Централ"</strong> за незабравими семейни моменти!
              </p>
              <div>
