            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ marginBottom: '20px' }}>
                  Настоящите Общи условия уреждат правилата за използване на уебсайта <strong>pizza-central.bg</strong>, собственост на <strong>Нолина 2007 ЕООД</strong>, както и условията за извършване на онлайн поръчки и резервации за маси чрез сайта.
                </p>
                <p style={{ marginBottom: '20px' }}>
