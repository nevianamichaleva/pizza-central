...
export const metadata = {
  ...
  description: "Ресторант-пицария Централ (бивш Моцарела) в Добрич предлага вкусна и здравословна храна, пица, основни ястия, обедни менюта и доставка до дома. Разполагаме с детски кът за вашите деца. Резервирайте маса или поръчайте онлайн.",
