...
export const metadata = {
  ...
  description: "Ресторант-пицария Централ (бивш Моцарела) в Добрич предлага вкусна и здравословна храна, пица, основни ястия, обедни менюта и доставка до дома. Разполагаме с детски кът за вашите деца.",
  ...
  openGraph: {
    ...
    description: 'Ресторант-пицария Централ в Добрич предлага вкусна и здравословна храна, обедни менюта и доставка до дома. Разполагаме с детски кът за вашите деца.',
    images: [
      {
