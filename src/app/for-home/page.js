...
const pageDescription =
  'Доставка на пица, паста, салати и ястия до адрес в Добрич от ресторант-пицария Централ (ул. Независимост 4). Такса за доставка 1,53 €. Официален сайт, без посредник, takeaway. Отстъпки за регистрирани. 10:00–22:00 ч.';
...
export const metadata = {
  ...
  keywords: [
    ...
    'такса доставка Добрич',
    'цена доставка храна Добрич',
    'доставка 1.53 евро',
  ],
  alternates: {
...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description:
        'Пица, паста, салати и основни ястия — доставка до адрес в Добрич и вземане от ресторанта на ул. Независимост 4. Такса за доставка 1,53 €.',
      address: {
        '@type': 'PostalAddress',
