...
const pageDescription =
  'Доставка на пица, паста, салати и ястия до адрес в Добрич от ресторант-пицария Централ (ул. Независимост 4). Такса за доставка 3 €. Официален сайт, без посредник, takeaway. Отстъпки за регистрирани. 10:00–22:00 ч.';
...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description:
        'Пица, паста, салати и основни ястия — доставка до адрес в Добрич и вземане от ресторанта на ул. Независимост 4. Такса за доставка 3 €.',
      address: {
        '@type': 'PostalAddress',
