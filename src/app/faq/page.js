  ...
  const faqCategories = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: <>Да. Регистрираните потребители получават <strong>5% отстъпка</strong> от стойността на поръчката (без доставка) при всяка поръчка. При избор на <strong>вземане от място</strong> се прилага <strong>10% отстъпка</strong> от стойността на поръчката. Можете да се регистрирате и да поръчате от нашата <Link href="/for-home" style={{ color: '#ce1212', textDecoration: 'underline' }}>страница за доставка</Link>.</>,
          answerText: "Да. Регистрираните потребители получават 5% отстъпка от стойността на поръчката (без доставка) при всяка поръчка. При избор на вземане от място се прилага 10% отстъпка от стойността на поръчката. Можете да се регистрирате и да поръчате от нашата страница за доставка."
        }
      ]
    },
    {
