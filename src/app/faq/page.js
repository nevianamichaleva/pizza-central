  ...
  const faqCategories = [
    {
      ...
      questions: [
        ...
        {
          question: "Имате ли отстъпки при поръчка?",
          answer: <>Да. Регистрираните потребители получават <strong>5% отстъпка</strong> върху продуктите и таксата за доставка при поръчка с доставка. При избор на <strong>вземане от място</strong> се прилага <strong>10% отстъпка</strong> от стойността на поръчката. Можете да се регистрирате и да поръчате от нашата <Link href="/for-home" style={{ color: '#ce1212', textDecoration: 'underline' }}>страница за доставка</Link>.</>,
          answerText: "Да. Регистрираните потребители получават 5% отстъпка върху продуктите и доставката при поръчка с доставка. При избор на вземане от място се прилага 10% отстъпка от стойността на поръчката. Можете да се регистрирате и да поръчате от нашата страница за доставка."
        }
      ]
    },
    {
      ...
      questions: [
        ...
        {
          question: "Деца под 3 години могат ли сами в детския кът?",
          answer: <>Деца под 3 години влизат в детския кът <strong>само заедно с придружител</strong> (родител или настойник). Повече информация има на нашата <Link href="/detski-kut" style={{ color: '#ce1212', textDecoration: 'underline' }}>страница за детски кът</Link>.</>,
          answerText: "Деца под 3 години влизат в детския кът само заедно с придружител (родител или настойник). Повече информация има на страницата за детски кът."
        },
        {
          question: "Каква е цената на детския кът?",
          answer: <>Цената на детския кът е <strong>1,53 евро</strong> на час, и <strong>2,05 евро за почасово гледане на деца</strong>. Следете нашата <Link href="/detski-kut" style={{ color: '#ce1212', textDecoration: 'underline' }}>страница за детски кът</Link> за редовните ни промоции на безплатен детски кът за децата.</>,
      ...
      questions: [
        {
          ...
          answer: <>Да, предлагаме разнообразни вегетариански опции и специално детско меню, подходящо за деца. Можете да разгледате <Link href="/central-menu" style={{ color: '#ce1212', textDecoration: 'underline' }}>пълното меню онлайн</Link>, където ще намерите всички опции.</>,
        ...
        // },
        // {
        //   question: "За кои области изпълнявате кетъринг поръчки?",
        //   answer: <>Изпълняваме поръчки за <strong>гр. Варна и Варненска област</strong>, както и за <strong>гр. Добрич и Добричка област</strong>. Разгледайте нашата <Link href="/catering" style={{ color: '#ce1212', textDecoration: 'underline' }}>страница за кетъринг</Link> за повече информация.</>,
        //   answerText: "Изпълняваме поръчки за гр. Варна и Варненска област, както и за гр. Добрич и Добричка област. Разгледайте нашата страница за кетъринг за повече информация."
        // },
        // {
        //   question: "За какви събития подходящ е кетърингът ви?",
        //   answer: <>Нашият кетъринг е подходящ за фирмени събития (коктейли, срещи, обучения, презентации), рождени дни, кръщенета и частни партита. Подхождаме индивидуално към всяка поръчка. Разгледайте нашата <Link href="/catering" style={{ color: '#ce1212', textDecoration: 'underline' }}>страница за кетъринг</Link> или се свържете с нас на телефон <strong>0895 516401</strong> или <strong>0893 315201</strong>.</>,
        //   answerText: "Нашият кетъринг е подходящ за фирмени събития (коктейли, срещи, обучения, презентации), рождени дни, кръщенета и частни партита. Подхождаме индивидуално към всяка поръчка. Разгледайте нашата страница за кетъринг или се свържете с нас на телефон 0895 516401 или 0893 315201."
        // },
        // {
        ...
        // },
        {
          ...
          answer: <>Информация за алергени и съставки е достъпна в нашето меню. Можете да разгледате <Link href="/central-menu" style={{ color: '#ce1212', textDecoration: 'underline' }}>пълното меню онлайн</Link> или да се свържете с нас за допълнителна информация относно конкретни ястия.</>,
